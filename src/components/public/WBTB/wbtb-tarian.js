...
function WarisanBudayaTarian() {
  const [tarianWbtbs, setTarianWbtbs] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (data) {
        ...
        const tarianWbtbArray = wbtbArray.filter(
          (wbtb) => wbtb.category === "Tarian"
        );
        setTarianWbtbs(tarianWbtbArray);
      }
    };
...
export default WarisanBudayaTarian;
